            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#navbar-examples" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples">
                        ...
                        <span class="nav-link-text" style="color: #f4645f;"><?php echo e(__('Admin')); ?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/chart">
                        <i class="fas fa-chart-pie text-green"></i> <?php echo e(__('Charts')); ?>

                    </a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('agents.index')); ?>">
                        <i class="ni ni-circle-08 text-pink"></i> <?php echo e(__('Agents')); ?>

                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/funds">
                        <i class="fas fa-funnel-dollar text-orange"></i> <?php echo e(__('Funds')); ?>

                    </a>
                </li>
                <li>
                    <a class="nav-link" href="#">
                        <i class="fas fa-money-check-alt text-blue"></i> <?php echo e(__('Payments')); ?>
...
</nav><?php /**PATH /opt/lampp/htdocs/RMS/resources/views/layouts/navbars/sidebar.blade.php ENDPATH**/ ?>